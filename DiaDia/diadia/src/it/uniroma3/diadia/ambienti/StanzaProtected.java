 ...
 * I suoi membri sono public o protected, il che li rende visibili in tutto il project(public) o in tutto il package 
 * e dalle sottoclassi(protected).
 * 
 * @author Wissel
 * @see Attrezzo
 * @version base
...
public class StanzaProtected {
	...
	public boolean equals(Object o)
	{
		...
		if(that==null)
		{
		 ...
		 //uguaglianza di nome
		 output=output && (this.getNome().equals(that.getNome()));
		 
		 //uguaglianza di attrezzi in stanza
		 //richiama equals @override di attrezzo
		 for(int i=0;i<this.getNumeroAttrezzi();i++)
		 {
			 output&=this.getAttrezzoIndice(i).equals(that.getAttrezzoIndice(i));
		 }
		 
		 //uguaglianza di  numero stanze adeacenti
		 output&=this.getNumeroStanzeAdeacenti()==that.getNumeroStanzeAdeacenti();
		 
		 //uguaglianza delle stanze adeacenti per nome
		 for(int i=0;i<this.getNumeroStanzeAdeacenti();i++)
		 {
			 output&=this.getNomeStanzaAdeacentePosiesima(i).equals(that.getNomeStanzaAdeacentePosiesima(i));
		 }
